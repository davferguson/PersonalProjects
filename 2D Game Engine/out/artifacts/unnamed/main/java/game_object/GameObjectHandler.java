...
public class GameObjectHandler {
    ...
    public GameObjectHandler(GamePanel gp) {
        ...
        gameObjects.add(new TreeObject(gp, treeImage, new Rectangle(1,1), 22, 16));
    }
    ...
    private void generateObjectImages() {
        try {
            //TREE_LARGE
            treeImage = ImageIO.read(new FileInputStream("src/main/resources/objects/TreeLarge_Object.png"));
